...
echo "<script type='text/javascript'> document.location = 'index.php'; </script>";
      ...
      echo "<script>alert('Detail tidak sesuai. Mohon coba kembali.');</script>";
    }
  }
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>D'Great Law | Forgot Password</title>
...
{
alert('Kolom Password Baru dan Konfirmasi Password tidak sesuai');
