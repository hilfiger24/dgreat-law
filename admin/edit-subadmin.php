...
if($query)
{
echo "<script>alert('Sub-admin details diperbaharui.');</script>";
}
else{
echo "<script>alert('Telah terjadi kesalah . Mohon coba kembali.');</script>";
} 
}
...
<html lang="en">
    <head>
        ...
        <title>D'Great Law |Edit Subadmin</title>
